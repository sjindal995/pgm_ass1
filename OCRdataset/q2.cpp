...
double avgDataLogLike(string words_filename, string img_ids_filename,  bool include_transition, bool include_skip){
	...
	while(getline(words_file, line)){
		...
		double prob = getProb(line, image_ids, include_transition, include_skip);
...
int main(int argc, char** argv){
	...
	ofstream out_file ("result/results_" + to_string(include_transition) + to_string(include_skip) + ".txt");
